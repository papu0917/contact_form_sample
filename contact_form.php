...
<section class="">
  <div class="entryform">
      <h2 class="lp-title entryform"><span class="contact__title first">永代供養付墓所のこと<br>小江戸聖地霊園のことをもっと知りたい方</span><br>資料請求はこちらから!</h2>
      ...
      <tr>
      <td>電話番号 <span>必須</span></td><td><input type="tel" name="tel" /></td>
      </tr>
      <tr>
      <td>メールアドレス <span>必須</span></td><td><input type="email" name="email" /></td>
      </tr>
      <tr>
      <td>郵便番号 <span>必須</span></td><td><input type="text" name="zip" id="postcode1" /></td>
      </tr>
      <tr>
      <td>都道府県 <span>必須</span></td><td>
      ...
      <tr>
      <td>市区町村・番地 <span>必須</span></td><td><input type="text" name="city" id="address2" /></td>
      </tr>
      <tr>
      <td>建物名・部屋番号</td><td><input type="text" name="address" /></td>
      </tr>
      <tr>
      <td>アンケート</td><td>当サイトをどこで知りましたか？<br><label><input type="checkbox" name="question[]" value="現地" /> 現地</label> <label><input type="checkbox" name="question[]" value="折込チラシ" /> 折込チラシ</label> <label><input type="checkbox" name="question[]" value="ネットの広告" /> ネットの広告</label> <label><input type="checkbox" name="question[]" value="検索サイト" /> 検索サイト</label> <label><input type="checkbox" name="question[]" value="その他" /> その他</label></td>
      </tr>
      <tr>
      <td>その他ご要望等</td><td><textarea name="message" cols="35" rows="8"></textarea></td>
      </tr>
      </tbody>
      </table>
